                    ...
                    <ul className="header__list">
                        {headerLinks.map((headerLink) => (
                            <li key={headerLink.id} className="header__list-item">
                                <HeaderLinkItem link={headerLink} onClick={() => setIsMenuOpened(false)} />
                            </li>
                        ))}
                    </ul>
                    <button onClick={() => setIsMenuOpened(false)} className="header__close-list-button close-list-button">
                        <IoMdClose />
                    </button>
                </div>
                {isCatalogOpened && (
